...
interface UserService {
    ...
    @POST("user/register")
    @FormUrlEncoded
    fun doRegister(@Field("username") username: String, @Field("password") password: String, @Field("repassword") repassword: String): Observable<ModelBase>

    @GET("user/logout/json")
    fun doLogout(): Observable<ModelLogin>
}